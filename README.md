...
index.html
~ here you can add more html files if you would like, you can also make a folder to store them in, but be sure to keep the index.html file at the top level of the folder, or else GitHub pages will not work properly
img/
	logo.png
